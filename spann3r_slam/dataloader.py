...
from spann3r_slam.spann3r_utils import resize_img
...
class MonocularDataset(torch.utils.data.Dataset):
    def __init__(self, dtype=np.float32):
        ...
        self.rgb_files = []
        self.timestamps = []
        # Spann3R demo and released checkpoints use 224 resolution by default.
        self.img_size = 224
...
class RGBFiles(MonocularDataset):
    def __init__(self, dataset_path):
        ...
        self.rgb_files = natsorted(list(set(rgb_files)))
