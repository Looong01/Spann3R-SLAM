import torch
from spann3r_slam.frame import Frame
from spann3r_slam.geometry import (
    act_Sim3,
    point_to_ray_dist,
    get_pixel_coords,
...
from spann3r_slam.nonlinear_optimizer import check_convergence, huber
from spann3r_slam.config import config
from spann3r_slam.spann3r_utils import spann3r_match_asymmetric
...
class FrameTracker:
    ...
    def track(self, frame: Frame):
        ...
        idx_f2k, valid_match_k, Xff, Cff, Qff, Xkf, Ckf, Qkf = spann3r_match_asymmetric(
